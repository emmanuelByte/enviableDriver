...
export class CompanyOrders extends Component {
  constructor(props) {
    super();
...
getOrders(){
  fetch(`${SERVER_URL}/mobile/vendor_get_rider_orders/${this.state.user.vendor_id}`, {
    method: 'GET'
 })
  ...
  if(this.state.orders < 1){
    return(
        <View  style={styles.noView}> 
                ...
                <Text style = {styles.ndt}>Your riders have no available order at the moment...</Text>
        </View>
    )
  }
}
