...
export class CompanyDispatchOrderDetails extends Component {
  constructor(props) {
    super();
          ...
          <View style={styles.cView}>
            ...
            <View style={styles.itemView}> 
              ...
              <View style={styles.item2}>
                <Text style = {styles.txt10}>{this.state.orderParam.receiver_name}</Text>
                <Text style = {styles.txt20}>{this.state.orderParam.receiver_phone}</Text>
              </View>
              <View style={styles.item3}>
                <Text style = {styles.label}>Address</Text>
                <Text style = {styles.txt}>{this.state.orderParam.delivery_address}</Text>
              </View>
            </View>
            <View style={styles.itemView}> 
              ...
              <View style={styles.item2}>
                <Text style = {styles.txt10}>{this.state.orderParam.sender_name}</Text>
                <Text style = {styles.txt20}>{this.state.orderParam.sender_phone}</Text>
              </View>
              <View style={styles.item3}>
                <Text style = {styles.label}>Address</Text>
                <Text style = {styles.txt}>{this.state.orderParam.pickup_address}</Text>
              </View>
            </View>
            {/*
            <View style={styles.itemView}>
            ...
            <View style={styles.item3}>
                ...
                */}
                <View style={styles.item22}>
                  ...
                  <Text style = {styles.labelZZ}>₦{parseFloat(this.state.orderParam.delivery_fee).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}</Text>
                </View>
              </View>
...
export default CompanyDispatchOrderDetails
