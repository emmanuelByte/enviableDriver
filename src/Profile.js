...
export class Profile extends Component {
  ...
  getReviews(){
    fetch(`${SERVER_URL}/mobile/get_rider_reviews/${this.state.user.id}`, {
      method: 'GET'
   })
   .then((response) => response.json())
   .then((res) => {
    ...
    return (
      <View style = {styles.body}>
        ...
        <Icon name="arrow-back" size={18} color="#fff"  style = {styles.menuImage}/>
          ...
          <TouchableOpacity style = {styles.editText} onPress={() => this.props.navigation.navigate('EditProfile')}>
            ...
            <View style={styles.itemView}>
              <View style={styles.item1}>
                ...
                */}
                  <View style={{flexDirection: 'row', paddingTop: 5}}>
                    <Text style = {styles.date}>{this.state.user.rating}*</Text> 
                    <Text style = {styles.label}>{this.state.reviews && this.state.reviews.length} reviews</Text>
                  </View>
                </View>
              </View>
            </View>
              ...
              <Text style = {styles.pName1}> Bank details</Text>
                <View style={styles.item11}>
                  ...
                  <View style={styles.contentCol31}> 
                    <Text style = {styles.address}> {this.state.user.bank_name && this.state.user.bank_name } {!this.state.user.bank_name && "Not set"}</Text>
                  </View>
                </View>
                <View style={styles.item11}>
                  <View style={styles.contentCol21}>
                  ...
                  <View style={styles.contentCol31}> 
                    <Text style = {styles.address}> {this.state.user.bank_account_type && this.state.user.bank_account_type} {!this.state.user.bank_account_type && "Not set"}</Text>
                  </View>
                </View>
                <View style={styles.item11}>
                  <View style={styles.contentCol21}>
                  ...
                  <View style={styles.contentCol31}> 
                    <Text style = {styles.address}> {this.state.user.bank_account_name && this.state.user.bank_account_name} {!this.state.user.bank_account_name && "Not set"}</Text>
                  </View>
                </View>
                <View style={styles.item11}>
                  <View style={styles.contentCol21}>
                  ...
                  <View style={styles.contentCol31}> 
                    <Text style = {styles.address}> {this.state.user.bank_account_number && this.state.user.bank_account_number} {!this.state.user.bank_account_number && "Not set"}</Text>
                  </View>
                </View>
              </View>
