...
import { AppState, View,  RefreshControl, Text, Switch, Alert, CheckBox, PermissionsAndroid, Image,TouchableWithoutFeedback, Button, TextInput, StyleSheet, Dimensions, ScrollView,BackHandler, ActivityIndicator, ImageBackground, StatusBar, TouchableOpacity, AsyncStorage } from 'react-native';
...
export class RideShareHome extends Component {
  constructor(props) {
    super();
        ...
        <ScrollView>
          <View>
            ...
            <View style = {styles.linkBody}>
              ...
              <TouchableOpacity onPress={this.navigateToScreen('RideShareHome')} style = {styles.linkItem}>
